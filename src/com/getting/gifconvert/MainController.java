...
public class MainController implements Initializable {
    ...
    private class GifConvertTask extends AsyncTask<ExecuteResult> {
        ...
        public void postTaskOnUi(ExecuteResult result) {
            ...
            showNotificationForAWhile(result.getStatus() == ExecuteResult.Status.SUCCESS ? "转换时间：" + FileUtil.getCostTimeDescription(result.getCostTime()) + "，转换后大小：" + FileUtil.formatFileSize(parameters.getOutputFile()) : "转换失败！！是否选择了有效的视频文件？");
        }
